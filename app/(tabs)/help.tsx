...
import { NativeEventEmitter, NativeModules, Platform, Pressable, Text } from 'react-native';
...
export default function HomeScreen() {
  ...
  return (
      ...
      <Pressable onPress={() => fetchSessionData()}>
        <Text style={{ color: '#990077', fontSize: 20, marginTop : 20, fontWeight: 'bold', textAlign: 'center' }}>Test Liveness Check</Text>
      </Pressable>
